...
#here::i_am("scripts/ResourceQuality_Analysis.R")
```
...
p_longdata <- read.csv(here("data/ResourceQuality_Pasteuria_Full_ByExptDay.csv"), stringsAsFactors = F)
...
m_longdata <- read.csv(here("data/ResourceQuality_Metsch_Full_ByExptDay.csv"), stringsAsFactors = F)
...
p_data$Diet2 = recode_factor(p_data$Diet, 'SM' = "50:50 SM", .default = levels(p_data_std$Diet))
