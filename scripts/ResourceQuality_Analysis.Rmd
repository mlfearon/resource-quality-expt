...
# Test is feeding rate predicts infection prevalence
...
m_maturespore_fig2 <- ggplot(m_data_maturespores, aes(x = Diet, y = mature_spores)) +
  ...
  labs(x = "Diet Treatment", y = "Mature Fungus Spore Yield (log scaled)") +
  theme_classic()  +
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=11, color="black"))
m_maturespore_fig2
...
```{r, Figure 1 and 2 of Metsh and Past infection prevalence, spore yield, spore size and spores}

Figure1 <- ggarrange(m_prev_fig3, m_maturespore_fig2, m_totgutspores_fig3, m_hemocytesperspore_fig3, labels = "auto",
                      ncol = 2, nrow = 2, legend = "bottom", common.legend = T)
Figure1
ggsave("figures/Fig1_FungusInfection.tiff", plot = Figure1, dpi = 600, width = 6.5, height = 7, units = "in", compression="lzw")



Figure2 <- ggarrange(p_prev_fig3, p_maturespore_fig2, sporesize_plot2, labels = "auto",
                      ncol = 2, nrow = 2)
Figure2
ggsave("figures/Fig2_BacteriaInfection.tiff", plot = Figure2, dpi = 600, width = 6.5, height = 7, units = "in", compression="lzw")
...
as.data.frame(pfecundmod_contrasts)
...
p_fecund_tot2 <- ggplot(p_data_fecund, aes(x = Infection, y = Total.Babies)) +
  ...
  #ggtitle("Total Fecundity by infection status x diet x host clone for Past Expt") +
  labs(x = "Parasite Exposure", y = "Total Fecundity") +
  theme_classic() + 
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=9, color="black"))
p_fecund_tot2
...
p_little_r2 <- ggplot(p_lifetable, aes(x = Infection, y = r_mx)) +
  ...
  scale_color_manual(values = diet_colors) +
  #ggtitle("Little r by infection status x diet x host clone for Past Expt") +
  labs(x = "Parasite Exposure", y = bquote("Per Capita Pop. Growth Rate (r"~day^-1~")")) +
  theme_classic() + 
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=9, color="black"))
p_little_r2
...
p_growth2 <- ggplot(p_data_growth, aes(x = Infection, y = GrowthRate)) +
  ...
  labs(x = "Parasite Exposure", y = bquote("Body Size Growth Rate ("* mu* "m" ~day^-1~")")) +
  theme_classic() + 
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=11, color="black"))
p_growth2
...
shapiro.test(resid(mgrowthmod)) # not sig, but 0.08
...
shapiro.test(resid(psizemod)) # not sig, but 0.055
...
p_size <- ggplot(p_data_size, aes(x = Infection, y = Length_Week1)) +
  ...
  scale_color_manual(values = c(rep("black", 4))) +
  ggtitle("Bacteria Experiment") +
  labs(x = "Parasite Exposure", y = bquote("Body Size During Parasite Exposure ("* mu* "m)")) +
  theme_classic() + 
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=11, color="black"))
p_size
...
shapiro.test(resid(msizemod)) # not sig, but 0.08
...
Figure3 <- ggarrange(m_feeding3, p_feeding3, m_little_r2, p_little_r2, m_survival_fig, p_survival_fig, labels = "auto",
                      ncol = 2, nrow = 3, widths = c(3.3,4))
Figure3
ggsave("figures/Fig3_Feeding_LittleR_Survival.tiff", plot = Figure3, dpi = 600, width = 8.5, height = 10, units = "in", compression="lzw")
...
shapiro.test(resid(mrespmod))   # significant, p = 0.039, But doesn't look too severe from the qqnorm plots (see https://stats.stackexchange.com/questions/32957/testing-normality-assumptions-for-linear-mixed-models-and-mixed-repeated-glm-a)
...
percentdif_fig <- ggplot(dif_data, aes(x = Metric, y = Percent_change, color = Experiment, fill = sig_fill_values, shape = Clone)) +
  ...
  scale_y_continuous(breaks = c(-1,-0.5,0,0.5,1,1.5,2,2.5,3), labels = c("-100%","","0%", "","100%","","200%","","300%")) +
