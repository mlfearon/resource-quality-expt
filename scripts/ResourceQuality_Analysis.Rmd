...
p_prev_feed_fig <- ggplot(past_prev_sum, aes(x = Mean_Clearance, y= Prevalence)) +
  ...
  geom_smooth(method = "lm", color = "black") +
  scale_color_manual(values = diet_colors) +
  labs(x = "Mean Feeding Rate (mL per hr)", y = "Bacteria Prevalence (%)") +
  ylim(-20, 100) +
  facet_wrap(~Clone) +
  theme_classic() +
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
...
p_maturespore_fig2 <- ggplot(p_data_spores_mature, aes(x = Diet, y = mature_spores)) +
  ...
  #scale_y_log10(labels = scales::comma, breaks = c(100, 1000, 10000,100000,1000000)) +
  #ggtitle("Mature Pasteuria Spore Yield by diet x host clone") +
  labs(x = "Diet Treatment", y = "Bacteria spore yield (log scaled)") +
  theme_classic() +
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=11, color="black"))
p_maturespore_fig2
...
sporesize_plot2 <- ggplot(p_data_spores_size, aes(x = Diet, y = AvgSporeSize, fill = Diet)) +
  ...
  scale_fill_manual(values = diet_colors) +
  labs(x = "Diet Treatment", y = bquote("Mean Bacteria Spore Area " ~ (mu *m^2))) +
...
p_little_r2 <- ggplot(p_lifetable, aes(x = Infection, y = r_mx)) +
  ...
  scale_color_manual(values = diet_colors) +
  ggtitle("Bacteria Experiment") +
  labs(x = "Infection Status", y = bquote("Per Capita Pop. Growth Rate (r"~day^-1*")")) +
  theme_classic() + 
  theme(axis.text = element_text(size=9, color = "black"), axis.title.y = element_text(size=11, color="black"), 
        axis.title.x = element_text(size=11, color="black"))
p_little_r2
...
Figure3 <- ggarrange(m_little_r2, p_little_r2, m_little_r3, p_little_r3, m_survival_fig, p_survival_fig, labels = "auto",
                      ncol = 2, nrow = 3, heights = c(3,3,3), legend = "right", common.legend = T)
Figure3
