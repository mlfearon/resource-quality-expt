...
pmaturesporemod2 <- lmer(log(mature_spores) ~ log(microcystin.avg+1) + Diet + Clone + (1|Block), data = p_data_spores_mature)
...
pmaturesporemod4 <- lmer(log(mature_spores) ~ log(microcystin.avg+1) * Clone + (1|Block), data = p_data_spores_M_tox)
summary(pmaturesporemod4)
Anova(pmaturesporemod4)
qqnorm(resid(pmaturesporemod4))
qqline(resid(pmaturesporemod4))
```
