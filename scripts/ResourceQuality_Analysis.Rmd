...
require("knitr")
#opts_knit$set(root.dir = "/resource-quality-expt/")
getwd()
```
...
# here::i_am("ResourceQuality_Analysis.Rmd")
...
ggsave("figures/PasteuriaPrev_DietxClone.tiff", plot = p_prev_fig2, dpi = 600, width = 4, height = 3, units = "in", compression="lzw")
...
ggsave("figures/PasteuriaPrevCalcualtions_DietxClone.tiff", plot = p_prev_fig3, dpi = 600, width = 4, height = 3, units = "in", compression="lzw")
```
